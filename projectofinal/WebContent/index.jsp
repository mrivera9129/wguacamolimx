				...
				<div id="carouselExampleIndicators" class="carousel slide my-4"
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active"
							style="background-image: url('https://image.freepik.com/foto-gratis/concepto-comida-mexicana-copyspace_23-2147812099.jpg'); background-size: cover; width: 100%; height: 300px;">

						</div>
						<div class="carousel-item"
							style="background-image: url('https://filesedc.com/uploads/291/img/2019/07/1200/comida-5d3ab588a643f.png'); background-size: cover; width: 100%; height: 300px;">

						</div>
						<div class="carousel-item"
							style="background-image: url('https://cdn.esbarrio.com/wp-content/uploads/2019/04/restaurantes-1200x400.jpg'); background-size: cover; width: 100%; height: 300px;">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="receta.jsp">Enchiladas</a>
								</h4>
                  ...
                  -->
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="https://i2.wp.com/thehappening.com/wp-content/uploads/2015/09/chile-en-nogada-nuevo.jpg?fit=1024%2C694&ssl=1"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Chile Nogada</a>
								</h4>
								<h5>Origen: Puebla</h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetur
                  ...
                  -->
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="https://www.mientrastantoenmexico.mx/wp-content/uploads/2015/07/unnamed-6.jpg"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Carne Asada</a>
								</h4>
								<h5>Origen: Monterrey</h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetur
									adipisicing elit. Amet numquam aspernatur! Lorem ipsum dolor
									sit amet.</p>
							</div>
			...
			<div class="row no-gutters">
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="https://tipsparatuviaje.com/wp-content/uploads/2018/09/enchiladas-comida-mexicana.jpg">
						<img class="img-fluid"
						...
						<div class="portfolio-box-caption">
							...
							<div class="project-name">Tips para preparar</div>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="https://cdn.foodandwineespanol.com/2018/10/maarten-van-den-heuvel-400626-unsplash.jpg">
						<img class="img-fluid"
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box"
						href="http://www.mexiconewsnetwork.com/wp-content/uploads/2018/11/gastronomia-mexicana-1-1000x600.jpg">
						<img class="img-fluid"
